            ...
            <div className="lp-hero-container">
                <div className="lp-hero-content">
                    ...
                    <div className="lp-hero-actions">
                        ...
                        <a href="https://wa.me/14155238886?text=join%20composed-birthday"
...
function ContactSection() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Fallback: open WhatsApp (Sandbox Twilio)
            const msg = encodeURIComponent(`join composed-birthday`);
            window.open(`https://wa.me/14155238886?text=${msg}`, '_blank');
            setSubmitted(true);
        } finally {
            setLoading(false);
        }
                    ...
                    <div className="lp-form-wrapper">
                        {!submitted ? (
                            ...
                            <div className="lp-form-success">
                                ...
                                <a href="https://wa.me/14155238886?text=join%20composed-birthday" className="lp-btn lp-btn-whatsapp" target="_blank" rel="noopener">
