            ...
            <div className="lp-hero-container">
                <div className="lp-hero-content">
                    ...
                    <div className="lp-hero-actions">
                        ...
                        <a href="https://wa.me/573177725056?text=Hola%2C%20me%20interesa%20una%20cotización%20de%20construcción"
...
function ContactSection() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            window.open(`https://wa.me/573177725056?text=${msg}`, '_blank');
            setSubmitted(true);
        } finally {
            setLoading(false);
        }
                    ...
                    <div className="lp-form-wrapper">
                        {!submitted ? (
                            ...
                            <div className="lp-form-success">
                                ...
                                <a href="https://wa.me/573177725056" className="lp-btn lp-btn-whatsapp" target="_blank" rel="noopener">
...
export default function LandingConstruccion() {
    return (
        <>
            ...
            <ContactSection />
            <Footer />
            <a href="https://wa.me/573177725056?text=Hola%2C%20vi%20su%20página%20y%20me%20interesa%20una%20cotización"
