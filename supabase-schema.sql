...
-- ============================================================
-- Fase 14: Marketplace y Punto de Venta
-- ============================================================
...
CREATE TABLE IF NOT EXISTS mk_ofertas (
  ...
  tipo TEXT,               -- heredado de insumo
  categoria TEXT,          -- heredado de insumo
  unidad TEXT,             -- heredado de insumo
  precio_venta DECIMAL(15,2) NOT NULL,
  stock_disponible INTEGER DEFAULT 0,
  tienda_nombre TEXT,      -- denormalizado para consultas rápidas en marketplace
  ciudad TEXT,             -- denormalizado desde punto_venta
...
-- Tiendas: solo el dueño gestiona
...
-- Puntos de venta: solo el dueño gestiona
...
-- Ofertas: el dueño gestiona, TODOS los autenticados pueden LEER las publicadas
...
-- Pedidos: comprador y vendedor pueden ver
